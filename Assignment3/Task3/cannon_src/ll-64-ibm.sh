...
date
mpiexec -n 64 ./cannon 64x64-1.in 64x64-2.in | tee 64_$JOB_ID.out
date
mpiexec -n 64 ./cannon 128x128-1.in 128x128-2.in | tee 128_$JOB_ID.out
date
mpiexec -n 64 ./cannon 256x256-1.in 256x256-2.in | tee 256_$JOB_ID.out
date
mpiexec -n 64 ./cannon 512x512-1.in 512x512-2.in | tee 512_$JOB_ID.out
date
mpiexec -n 64 ./cannon 1024x1024-1.in 1024x1024-2.in | tee 1024_$JOB_ID.out
date
mpiexec -n 64 ./cannon 2048x2048-1.in 2048x2048-2.in | tee 2048_$JOB_ID.out
date
mpiexec -n 64 ./cannon 4096x4096-1.in 4096x4096-2.in | tee 4096_$JOB_ID.out
date
